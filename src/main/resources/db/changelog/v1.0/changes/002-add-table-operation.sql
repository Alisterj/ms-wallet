...
CREATE TABLE operation_wallet (
    ...
    CONSTRAINT fk_operation_wallet_id
        FOREIGN KEY (wallet_id) REFERENCES wallet (id) ON DELETE NO ACTION ON UPDATE CASCADE
);
...
CREATE TABLE history_transaction(
    ...
    CONSTRAINT fk_history_transaction_wallet_id
        FOREIGN KEY (wallet_id) REFERENCES wallet (id) ON DELETE NO ACTION ON UPDATE CASCADE
);
